...
additionalKMS.init = function(){
  ...
  (()=>{
    ...
    */
    ...
    with(commons.consts){
      ...
      list[帽子][レア]     = [].concat(pstatus1,                  istatus1, iall1, iatk1, ima1, php, pmp, ihp, imp, pdef, idef, ispd, ijmp);
      ...
      list[手袋] = [];
      list[手袋][レジェ]   = [].concat(pstatus1, pall1, lvstatus, istatus1, iatk1, ima1, pcrd1, pcrd2, php, pmp, ihp, imp, oeff, pmeso, pdrop);// list[帽子][レジェ].del([ict1]).concat(pcrd2);
  ...
  */
  ...
  , "HP回復 攻撃時20%の確率" : [ 2 /* アディ15% アディMP共通 テンプレート名はそのまま */
    , [/*レジェ*/]
    , [/*ユニ*/
        [0, 40], [11, 45], [21, 50], [31, 55], [41, 60], [51, 65], [61, 70], [71, 75], [81, 80], [91, 85], [101, 90], [111, 95], [201, 100]
      ]
    , [/*エピ*/]
    , [/*レア*/]
    , [/*ノーマル*/]
