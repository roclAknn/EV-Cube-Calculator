...
(()=>{
  ...
  */
  ...
  (()=>{
    ...
    = data.equipmentpotential["rareadditional"] = list;
    list[武器] = [];
...
, "HP回復 攻撃時20%の確率" : [ 2 /* アディは15% アディMP共通 テンプレート名はそのまま */
  , [/*レジェ*/]
  , [/*ユニ*/
...
list[ohp1]   = ["HP回復 攻撃時15%の確率",       pt["HP回復 攻撃時20%の確率"]];  /*テンプレート名は変えない*/
list[omp1]   = ["MP回復 攻撃時15%の確率",       pt["HP回復 攻撃時20%の確率"]];  /*アディはHP共通*/
