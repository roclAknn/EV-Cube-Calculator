...
regularKMS.init = function(){
  ...
  */
  ...
  , "攻撃力1" : [ 1 /*共通 魔力*/
    ...
    , [/*エピ*/]
    , [/*レア*/
        [0, 2], [21, 4], [41, 6], [61, 8], [81, 10], [91, 12], [201, 13]
      ]
    , [/*ノーマル*/
  ...
  , "HP回復 攻撃時20%の確率" : [ 2
    ...
    , [/*ユニ*/]
    , [/*エピ*/
        [0, 30], [11, 60], [21, 90], [31, 120], [41, 150], [51, 180], [61, 210], [71, 240], [81, 270], [91, 300], [101, 330], [111, 360], [201, 370]
      ]
    , [/*レア*/
        [0, 20], [11, 40], [21, 60], [31, 80], [41, 100], [51, 120], [61, 140], [71, 160], [81, 180], [91, 200], [101, 220], [111, 240], [201, 250]
      ]
    , [/*ノーマル*/]
    ]
  , "MP回復 攻撃時20%の確率" : [ 2
    ...
    , [/*ユニ*/]
    , [/*エピ*/
        [0, 30], [11, 45], [21, 60], [31, 75], [41, 90], [51, 105], [61, 120], [71, 135], [81, 150], [91, 165], [101, 180], [201, 195]
      ]
    , [/*レア*/
        [0, 20], [11, 30], [21, 40], [31, 50], [41, 60], [51, 70], [61, 80], [71, 90], [81, 100], [91, 110], [101, 120], [201, 125]
      ]
    , [/*ノーマル*/]
    ]
  ...
  , "HP回復 攻撃時3%の確率" : [ 2 /* 共通 MP回復 攻撃時3%の確率 */
    ...
    , [/*ユニ*/]
    , [/*エピ*/
        [0, 20], [11, 23], [21, 26], [31, 29], [41, 32], [51, 35], [61, 38], [71, 41], [81, 44], [91, 47], [101, 50], [111, 53], [201, 54]
      ]
    , [/*レア*/
        [0, 10], [11, 12], [21, 14], [31, 16], [41, 18], [51, 20], [61, 22], [71, 24], [81, 26], [91, 28], [101, 30], [111, 32], [201, 33]
      ]
    , [/*ノーマル*/]
    ]
  ...
  , "HP回復 モンスター退治時15%の確率" : [ 2 /*共通 MP回復 モンスター退治時15%の確率*/
    ...
    , [/*ユニ*/]
    , [/*エピ*/
        [0, 40], [11, 45], [21, 50], [31, 55], [41, 60], [51, 65], [61, 70], [71, 75], [81, 80], [91, 85], [101, 90], [111, 95], [201, 97]
      ]
    , [/*レア*/]
    , [/*ノーマル*/]
    ]
  , "HP回復 4秒ごと" : [ 2 /*共通 MP回復 4秒ごと*/
    ...
    , [/*エピ*/]
    , [/*レア*/
        [0, 2], [11, 4], [21, 6], [31, 8], [41, 10], [51, 12], [61, 14], [71, 16], [81, 18], [91, 20], [101, 22], [111, 24], [201, 25]
      ]
    , [/*ノーマル*/]
    ]
  ...
  , "レベル中毒 攻撃時20%の確率" : [ 2 /*共通 レベル中毒 攻撃時10%の確率*/
    ...
    , [/*エピ*/]
    , [/*レア*/
        [10, 1], [21, 2], [41, 3], [61, 4], [81, 5], [101, 6], [201, 7]
      ]
    , [/*ノーマル*/]
    ]
  , "レベル気絶 攻撃時10%の確率" : [ 2
